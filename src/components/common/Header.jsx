...
import { ROLES, SIDEBAR_ACCESS } from '../../services/adminService'
      ...
      <header className="sticky top-0 z-20 w-full h-16 bg-[#FFFDF9] border-b border-[#E7DED2] flex justify-between items-center px-6 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-[#74777e] mt-0.5 font-medium hidden sm:block">
              Relief Match Coordination Environment
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="text-xs text-[#74777e] pr-4">Search requests, supplies, camps...</span>
          ...
          <div className="w-[280px] bg-[#17324D] text-white h-full p-6 flex flex-col space-y-4 shadow-2xl">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-[#D98B3A] text-2xl">handshake</span>
                <span className="font-bold text-lg">Relief Match</span>
              </div>
